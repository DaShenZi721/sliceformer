...
def cli_main():
    # state = torch.load('/home/shen_yuan/retro/HGA/pretrained_checkpoint/GNN_new.ckpt', map_location=lambda storage, loc: storage)
    # new_state = dict()
    # for k,v in state['state_dict'].items():
    #     new_state[k] = v
    # torch.save(new_state, '/home/shen_yuan/retro/HGA/pretrained_checkpoint/GNN_new2.ckpt')
    #
    # 1/0
    # ------------
    # args
    ...
    wandb.init(project='graphormer', config=args, mode='online')
